...
const std::string testLuksDevName = "testfile_luksDev";
...
class EStoragedTest : public testing::Test
{
  public:
    ...
    static constexpr auto testPath = "/test/openbmc_project/storage/test_dev";
    static constexpr auto estoragedInterface =
    ...
    {
        EXPECT_EQ(0, unlink(testFileName.c_str()));
    }
};
...
TEST_F(EStoragedTest, FormatPass)
{
    ...
    EXPECT_CALL(*mockFsIface, runMkfs(testLuksDevName.c_str()))
        .WillOnce(Return(0));
